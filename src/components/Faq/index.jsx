  ...
  return (
    <>
      <div
       ...
       "
      >
        <h1 className="text-lg md:text-4xl tracking-[-2.2%] font-bold text-center font-circular-std leading-[72px] text-white mt-6">
          Frequently Asked Questions
        </h1>
        <div>
          <div>
            <h2 className="leading-[32px] tracking-[-1.9%] text-lg md:text-2xl text-white font-bold my-8 ">
